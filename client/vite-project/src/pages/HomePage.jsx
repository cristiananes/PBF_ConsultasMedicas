    ...
    <main style={styles.mainContainer}>
        ...
        <nav style={styles.nav}>
          <ul style={styles.navList}>
            <li style={styles.navItem}>
              <NavLink to="/consults" style={styles.navLink}>
                Ver Consultas
              </NavLink>
            </li>
            <li style={styles.navItem}>
              <NavLink to="/doctores" style={styles.navLink}>
                Encontrar Médicos
              </NavLink>
            </li>
            <li style={styles.navItem}>
      ...
      <section style={styles.banner}>
        <h2 style={styles.bannerTitle}>
          Bienvenidos a la Página de Consultas Médicas
        </h2>
        <p style={styles.bannerDescription}>
          Encuentra médicos destacados y agenda consultas de manera sencilla y
          rápida.
        </p>
      </section>
